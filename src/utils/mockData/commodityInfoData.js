...
const commodityInfoData = [
  ...
  },
  {
    ...
    name: "劳力士 潜航者型系列 男士绿水鬼手表 自动机械男腕表 116610LV-97200",
    price: "96000",
    volume: "9983",
    isHave: false,
    isDirect: false,
  ...
  },
  {
    ...
    name: "三只松鼠营养早餐口袋面包网红零食饼干蛋糕乳酸菌小伴侣面包520g整箱装",
    price: "26.9",
    volume: "43892",
    isHave: false,
    isDirect: true,
...
Mock('commodityInfoData', data => {
  let params =  data.body
  let str = JSON.parse(params)
  let index = str.params
  return {
    status: "200",
    data: commodityInfoData[index]
  }
}, "post")
// Mock.mock("http://localhost:8080/commodityInfoData", "post", data => {
//   let params =  data.body
//   let str = JSON.parse(params)
//   let index = str.params
//   return {
